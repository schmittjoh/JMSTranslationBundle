...
class ValidationExtractor implements FileVisitorInterface, \PHPParser_NodeVisitor
{
    ...
    public function enterNode(\PHPParser_Node $node)
    {
        ...
        $metadata = ($this->metadataFactory instanceOf ClassMetadataFactoryInterface)? $this->metadataFactory->getMetadataFor($name) : $this->metadataFactory->getMetadataFor($name);
