...
class ExtractTranslationCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ...
            ->addOption('load-resource', null, InputOption::VALUE_IS_ARRAY | InputOption::VALUE_REQUIRED , 'Load external translation ressources (only xliff)')
        ;
    }
    ...
    private function getConfigFromInput(InputInterface $input, ConfigBuilder $builder)
    {
        ...
        if ($loadResource = $input->getOption('load-resource')) {
